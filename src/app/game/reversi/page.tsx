...
function ReversiContent() {
  ...
  if (authLoading || loading || isLeaving) {
    return <div className="min-h-screen flex items-center justify-center bg-white"><Loader2 className="animate-spin text-[#334155] w-8 h-8" /></div>;
  }
...
export default function ReversiPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-white"><Loader2 className="animate-spin text-[#334155] w-8 h-8" /></div>}>
      <ReversiContent />
    </Suspense>
  );
}
